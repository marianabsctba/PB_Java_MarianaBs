...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<a href="#" class="logo d-flex align-items-center"> <img
		src="/img/logo.png" alt=""> <span class="d-none d-lg-block">Good
			Hands</span>
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			<li class="nav-link active"><a href="/home">Sobre</a></li>
			<li class="nav-link active"><a href="/">Index</a></li>
		...
		<ul class="nav navbar-nav">
			<c:if test="${empty user}">
				<li><a href="/usuario"><span class="bi bi-pencil-fill"></span>
						Sign Up /</a></li>
				<li><a href="/login"><span class="bi bi-person"></span>
						Login</a></li>
			</c:if>
			<c:if test="${not empty user}">
				<li><a href="/logout"><span class="bi bi-dash-circle"></span>
